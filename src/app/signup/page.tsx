...
export default function SignupPage() {
  ...
  const { signUpWithEmail, sendUserEmailVerification } = useAuth();
  ...
  const onSubmit = async (data: SignupFormValues) => {
    ...
    try {
      ...
      // Optionally send verification email right after signup
      if (userCredential.user) {
        await sendUserEmailVerification();
      }

      router.push('/'); // Redirect to homepage or a "please verify email" page
    } catch (error: any) {
